...
medmod <- "
  # Direct effect
  SEXASSAULT ~ a1 * parties + a2 * family_drink + a3 * highschool_drink 
  
  # Mediator
  DRINKCAT ~ b1 * parties + b2 * family_drink + b3 * highschool_drink 
...
med_others_mod <- "
  # Direct effect
  SEXASSAULT_others ~ a1 * parties + a2 * family_drink + a3 * highschool_drink 
...
med_them_mod <- "
  # Direct effect
  SEXASSAULT_them ~ a1 * parties + a2 * family_drink + a3 * highschool_drink 
