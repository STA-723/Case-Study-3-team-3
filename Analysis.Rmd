...
```{r}
cas97_glm_full<-cas97 %>% select(grep("^B8_B$|^B8_C$|^B12_A$|^B7_A$|^B7_B$|^B7_C$|^B7_D$|^B7_E$|^B7_F$|^B8_D$|^B12_B$|^B9_C$|^B9_G$|^B1$|^B6_A$|^B6_B$|^B9_A$|^B9_D$|^B9_E$|^B9_F$|^B13_A$|^B13_B$|^B9_B$|^B11$|^B6_E$|^B6_C$|^B13_E$|^B2$|^B3$|^B13_C$|^B13_D$|^B6_D$|^F5_A|^F5_B|^F5_C|^F5_D|^F5_E|^F5_F|^F5_G|^F5_H|^F6_A|^F6_B|^F6_C|^F6_D|^F6_E|^F6_E|^F6_F|^F6_G|^F6_H|^F6_I|^F1|^F4|^F2|^F3|^G2|^G3|^G4|^G8|^G9|^G10|^G15|^G14|^G16|^G17|^G13|^A8|^D2|^D8|^D9|^D3|^D1|^A9|^A10|^DRINKCAT",colnames(.))) %>%
...
```{r}
cas97_glm<-cas97 %>% select(grep("^B8_B$|^B8_C$|^B12_A$|^B7_A$|^B7_B$|^B7_C$|^B7_D$|^B7_E$|^B7_F$|^B8_D$|^B12_B$|^B9_C$|^B9_G$|^B1$|^B6_A$|^B6_B$|^B9_A$|^B9_D$|^B9_E$|^B9_F$|^B13_A$|^B13_B$|^B9_B$|^B11$|^B6_E$|^B6_C$|^B13_E$|^B2$|^B3$|^B13_C$|^B13_D$|^B6_D$|^F5_A|^F5_B|^F5_C|^F5_D|^F5_E|^F5_F|^F5_G|^F5_H|^F6_A|^F6_B|^F6_C|^F6_D|^F6_E|^F6_E|^F6_F|^F6_G|^F6_H|^F6_I|^F1|^F4|^F2|^F3|^G2|^G3|^G4|^G8|^G9|^G10|^G15|^G14|^G16|^G17|^G13|^A8|^D2|^D8|^D9|^D3|^D1|^A9|^A10|^DRINKCAT",colnames(.))) %>%
...
```{r}
long_cas97_glm<-cas97_glm %>% select(grep("^A|^DRINK",colnames(.))) %>% pivot_longer(cols=-DRINKCAT,names_to = "value",names_repair="unique")
...
modd <- '
  # Regression
  DRINKCAT ~ Policy + Approp_Drinks + D2 + D8 + D9
  # Latent variable definition
...
DRINKCAT <- ordered(cas97$DRINKCAT)
drinkcat <- cas97 %>%
  select(grep("^F5|^F6|^F1|^F4|^F2|^F3", colnames(.))) %>%
  mutate(DRINKCAT = DRINKCAT) %>%
  filter(complete.cases(.))
...
fullmod <-'
  # Regression
  DRINKCAT ~ comms +
            #CollegePolicy + CollegeEdu + Policy + CityPolicy
            Approp_Drinks + Fam + HS +
            personal_wellbeing + academic_wellbeing + social_groups 
            
  sexual_assault ~ DRINKCAT + social_groups + comms
  
  # Latent variable definition
  comms =~ A10_A + A10_B +A10_C + A10_D + A10_E + A 10_F +A10_G + A10_H
  Policy =~ D3_A + D3_B + D3_C + D3_D +D3_E + D3_F + D3_G + D3_H + D3_I + D3_J  
  Approp_Drinks =~ D1_A + D1_B + D1_C + D1_D +D1_E
  Fam =~ G14 + G15 + G16 + G17
  HS =~ G8 + G9 + G10
...
DRINKCAT <- ordered(cas97$DRINKCAT)
drinkcat <- cas97 %>%
  select(grep("^F5|^F6|^F1|^F4|^F2|^F3|^G2|^G3|^G4|^G8|^G9|^G10|^G15|^G14|^G16|^G17|^G13|^A6|^A8|^D2|^D8|^D9|^D3|^D1|^A9|^A10|^B8_B$|^B8_C$|^B12_A$|^B7_A$|^B7_B$|^B7_C$|^B7_D$|^B7_E$|^B7_F$|^B8_D$|^B12_B$|^B9_C$|^B9_G$|^B1$|^B6_A$|^B6_B$|^B9_A$|^B9_D$|^B9_E$|^B9_F$|^B13_A$|^B13_B$|^B9_B$|^B11$|^B6_E$|^B6_C$|^B13_E$|^B2$|^B3$|^B13_C$|^B13_D$|^B6_D$|^sex_assualt", colnames(.))) %>%
  mutate(G15 = scale(G15),
         G16 = scale(G16),
         G17 = scale(G17),
         G10 = scale(G10),
         ...
         B13_A = scale(B13_A),
         B2 = scale(B2),
         B12 = scale(B12_A + B12_B),
         B8 = scale(B8_B + B8_C + B8_D),
         B7 = scale(B7_A + B7_B + B7_C + B7_D + B7_E + B7_F)
         ) %>% 
  mutate(DRINKCAT = DRINKCAT) %>% 
  drop_na()
...
fullmod <-'
  ...
  DRINKCAT ~ 1*comms +
            Policy + Approp_Drinks + 
            CollegePolicy + CollegeEdu + CityPolicy +
            Fam + HS +
            personal_wellbeing + academic_wellbeing + social_groups
...
```{r, cache=TRUE}
indep_vars_patterns <- "^B8_B$|^B8_C$|^B12_A$|^B7_A$|^B7_B$|^B7_C$|^B7_D$|^B7_E$|^B7_F$|^B8_D$|^B12_B$|^B9_C$|^B9_G$|^B1$|^B6_A$|^B6_B$|^B9_A$|^B9_D$|^B9_E$|^B9_F$|^B13_A$|^B13_B$|^B9_B$|^B11$|^B6_E$|^B6_C$|^B13_E$|^B2$|^B3$|^B13_C$|^B13_D$|^B6_D$|^F5_A|^F5_B|^F5_C|^F5_D|^F5_E|^F5_F|^F5_G|^F5_H|^F6_A|^F6_B|^F6_C|^F6_D|^F6_E|^F6_E|^F6_F|^F6_G|^F6_H|^F6_I|^F1|^F4|^F2|^F3|^G2|^G3|^G4|^G8|^G9|^G10|^G15|^G14|^G16|^G17|^G13|^A8|^D2|^D8|^D9|^D3|^D1|^A9|^A10|^D4_H|^D4_I|^E15"
DRINKCAT <- ordered(cas97$DRINKCAT)
...
medmod <- "
  # Direct effect
  SEXASSAULT ~ a1 * parties + a2 * fam_drink + a3 * hs_drink 
  
  # Mediator
  DRINKCAT ~ b1 * parties + b2 * fam_drink + b3 * hs_drink 
  ...
  fam_drink =~ G14 + G15 + G16 + G17
  hs_drink =~ G8 + G9 + G10
  parties =~ A10_D + A 10_F
"

med_others_mod <- "
  # Direct effect
  SEXASSAULT_others ~ a1 * parties + a2 * fam_drink + a3 * hs_drink 
...
med_them_mod <- "
  # Direct effect
  SEXASSAULT_them ~ a1 * parties + a2 * fam_drink + a3 * hs_drink 
