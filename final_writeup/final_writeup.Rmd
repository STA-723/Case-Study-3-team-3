...
```{r, results='asis', eval=FALSE, echo=FALSE, fig.align = "center",fig.pos="h"}
...
```{r, eval=FALSE, echo=FALSE, results='asis', fig.align = "center", fig.pos="h"}
...
```{r, results='asis', eval=FALSE, echo=FALSE, fig.pos="h"}
knitr::kable(medass_coef %>% 
               head(7) %>%
