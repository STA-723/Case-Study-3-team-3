...
```{r, echo = FALSE, fig.cap="\\label{tab:full-coefs}"}
library(dplyr)
...
knitr::kable(full_coefs %>% 
             ...
             align = "c",
             caption = "\\label{tab:full-coefs}Coefficient estimates and 95% confident intervals of latent factors in the SEM for levels of drinking. High school drinking (highschool_drink), support of more lenient drinking policy (attitude_policy), importance of parties (parties), less exposure to alcohol education (college_edu), family drinks, and personal wellbeing are associated with more drinking in college."
             )
```
