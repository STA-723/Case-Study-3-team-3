...
```{r reasons-eda, echo=FALSE, eval=TRUE,out.width = "300px", fig.align="center", fig.pos="h", fig.cap="\\label{fig:latent-vars}The figure shows survey."}
...
```{r graphical_latent, echo = FALSE, eval = TRUE, fig.pos = "h",out.width = "300px", fig.align="center", fig.cap="\\label{fig:graphical-latent} Graphical representation of latent variable model DRINKCAT response."}
knitr::include_graphics("plots/latent_variable_model.png")

```

```{r graphical_mediation, echo = FALSE, eval = TRUE, fig.pos = "h",out.width = "300px", fig.align="center", fig.cap="\\label{fig:graphical-mediation} Graphical representation of mediation analysis."}
